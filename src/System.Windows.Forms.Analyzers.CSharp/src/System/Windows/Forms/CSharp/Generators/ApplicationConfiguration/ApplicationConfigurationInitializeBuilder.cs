...
{
    // The SDK owns Initialize and its existing DPI/bootstrap policy. An absent
    // font has no implementation, so C# erases the optional hook and its call.
    public static string GenerateSdkDefaultFont(string defaultFont) => $$"""
        // <auto-generated />
        internal static partial class ApplicationConfiguration
        {
            static partial void ConfigureDefaultFont()
            {
                global::System.Windows.Forms.Application.SetDefaultFont({{defaultFont}});
            }
        }
        """;
