...
The verified source checkpoint pins ProGPU commit `d9facb7fee8314cd6014b039da94a700938aefbf`. A clean source-first run passes the platform contracts (20/20), ProGPU host contracts (8/8), canonical lifecycle/retained-paint/input plus owned/nested-modal, multi-monitor, logical presentation-scale, and per-monitor-V2 DPI integration (7/7), and ProGPU drawing quality suite (115/115). The canonical portable build remains at its reviewed 619-warning/zero-error baseline. A fresh-cache package consumer builds with warnings treated as errors; the packed `System.Windows.Forms.dll` SHA-256 is `09e1e39ff8607151021f69e3c3813cdd5671aa69084dc4f0e28b7ea81927d385`, `LibreWinForms.Platform.dll` SHA-256 is `2fa178d77c9360c28b9858e99633a1406ad9c07ad28c0c04642b0d92528d14d5`, and the source-first package SHA-256 is `aae36fd3820339724ff826502d5c2d1d4c7f7faad7bc16baddb171b0e46054c9`.
