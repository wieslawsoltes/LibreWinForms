...
The verified source checkpoint pins ProGPU commit `5c5345609725318c5af80ba7ddd9e2bd6bdbbe20`, which integrates the formatted-text slice with current ProGPU `main`. A clean hosted source-first run passes the platform contracts (20/20), ProGPU host contracts (8/8), canonical lifecycle/retained-paint/input plus owned/nested-modal, multi-monitor, logical presentation-scale, and per-monitor-V2 DPI integration (7/7), and the complete ProGPU drawing quality suite (138/138). The hosted Linux lane provisions Mesa's software Vulkan adapter because those quality cases execute the production typed WebGPU recording/readback path. The canonical ProGPU-backed build remains at its reviewed 613-warning/zero-error baseline. The hosted package contains the canonical implementation/reference assets, declares `ProGPU.System.Drawing.Common` as a normal dependency, does not embed ProGPU assemblies, and passes a fresh-cache consumer build with warnings treated as errors; the packed `System.Windows.Forms.dll` SHA-256 is `ebb09d23a2cbc460d55114100f3b891f7b9cf46ec073176a90b0a77289171ae8`, the packed `LibreWinForms.Platform.dll` SHA-256 is `d8beb6fd36bdb5346e8789f117628a9f232b5f7ca6b50369ce703df1acfd025c`, and the uploaded `canonical-source-first-package` artifact SHA-256 digest is `dfa5fac937a1a09f89e0985c8fbdf952c4374f258e0f306cdd759ba67143ab6c`.
