...
```bash
LIBREWINFORMS_DEV_PACKAGE_VERSION=0.1.0-preview.43 ./eng/librewinforms-pack.sh
```
...
```bash
LIBREWINFORMS_DEV_PACKAGE_VERSION=0.1.0-preview.43 \
LIBREWINFORMS_BRIDGE_PACKAGE_VERSION=0.1.0-preview.43 \
