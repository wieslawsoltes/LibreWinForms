...
```xml
<Project Sdk="LibreWinForms.Sdk/0.1.0-preview.32">
  <PropertyGroup>
    <OutputType>WinExe</OutputType>
    <TargetFramework>net10.0</TargetFramework>
    <UseWindowsForms>true</UseWindowsForms>
...
```bash
LIBREWINFORMS_DEV_PACKAGE_VERSION=0.1.0-preview.32 ./eng/librewinforms-pack.sh
```
...
```bash
LIBREWINFORMS_DEV_PACKAGE_VERSION=0.1.0-preview.32 \
LIBREWINFORMS_BRIDGE_PACKAGE_VERSION=0.1.0-preview.32 \
LIBREWINFORMS_PROGPU_PACKAGE_VERSION=0.1.0-preview.28 \
